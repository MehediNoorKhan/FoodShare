    ...
    return (
        <section className="py-16" id="contact">
            <div className='max-w-7xl mx-auto'>
                <h2 className="text-3xl font-bold text-deepgreen text-center mb-12">Contact Us</h2>
                <div className="contact-container  flex flex-col md:flex-row  gap-6">

                    {/* Left image */}
                    <div className="contact-image flex-1">
                        <img src={foodsharing} alt="Food Sharing" />
                    </div>

                    {/* Right form */}
                    <div className="contact-form-wrapper bg-green-50 flex-1 p-8 relative">
                        {/* Social Media Icons */}
                        <div className="social-icons flex justify-center gap-4 mb-6">
                            {/* Instagram */}
                            <a href="https://www.instagram.com/cristiano/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                        ...
                        <form className="contact-form flex flex-col gap-2" onSubmit={handleSubmit}>
                            <h2 className="text-2xl font-bold mb-4">Send Us Message</h2>

                            <label htmlFor="name">Name</label>
                            <input type="text" id="name" name="name" placeholder="Your Name" className='bg-white' required />
                            ...
                            <textarea id="message" name="message" placeholder="Write your message..." rows="3" required />
